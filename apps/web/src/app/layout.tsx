    ...
    <html lang="en">
      <body className="min-h-full flex flex-col">
        <div className="app-container">
            ...
            <nav className="nav-container" aria-label="Main Navigation">
              <Link href="/" className="brand-logo" id="nav-brand-logo">
                ...
                <div style={{ display: "flex", flexDirection: "column", lineHeight: 1 }}>
                  ...
                  <span style={{ fontSize: "0.6rem", textTransform: "uppercase", letterSpacing: "0.08em", color: "var(--text-muted)", marginTop: "2px" }}>
                    Alberta Pickup Intelligence
                  </span>
                </div>
                <span className="brand-badge" style={{ marginLeft: "0.35rem" }}>
                  v1.1.9
                </span>
              </Link>

              {/* Header Actions: Docs and Admin */}
          ...
          >
            {/* Left Column: Disclaimer & Privacy & Docs Links */}
